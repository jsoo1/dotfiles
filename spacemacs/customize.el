...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (zeal-at-point yapfify yaml-mode xterm-color ws-butler winum which-key wgrep web-mode web-beautify volatile-highlights vimrc-mode vi-tilde-fringe vala-snippets vala-mode uuidgen use-package twittering-mode treemacs-projectile treemacs-evil treemacs pfuture toml-mode toc-org thrift tagedit systemd symon string-inflection stan-mode sql-indent spaceline powerline smex smeargle slime-company slime slim-mode slack circe oauth2 websocket shen-elisp shell-pop scss-mode scad-mode sayid sass-mode restart-emacs realgud test-simple loc-changes load-relative ranger rainbow-delimiters racer qml-mode pyvenv pytest pyenv-mode py-isort pug-mode psci purescript-mode psc-ide proof-general powershell popwin pkgbuild-mode pippel pip-requirements persp-mode pcre2el password-generator paradox ox-reveal overseer orgit org-projectile org-category-capture org-present org-pomodoro org-download org-bullets org-brain org-plus-contrib open-junk-file ob-restclient ob-http nix-mode nginx-mode nand2tetris nameless multi-term mu4e-maildirs-extension mu4e-alert move-text mmm-mode matlab-mode markdown-toc markdown-mode magit-gitflow macrostep lorem-ipsum logcat livid-mode skewer-mode live-py-mode linum-relative link-hint kivy-mode julia-mode js2-refactor js2-mode js-doc js-comint ivy-rtags ivy-purpose window-purpose imenu-list ivy-hydra intero insert-shebang info+ indent-guide importmagic epc ctable concurrent impatient-mode simple-httpd idris-mode prop-menu ibuffer-projectile hy-mode hungry-delete htmlize hoon-mode hlint-refactor hl-todo hindent highlight-parentheses highlight-numbers parent-mode highlight-indentation hide-comnt help-fns+ helm-make haskell-snippets haml-mode groovy-mode graphviz-dot-mode gradle-mode google-translate google-c-style golden-ratio gnuplot gitignore-mode gitconfig-mode gitattributes-mode git-timemachine git-messenger git-link git-gutter-fringe+ git-gutter-fringe fringe-helper git-gutter+ git-gutter gh-md ggtags fuzzy fsharp-mode company-quickhelp flyspell-correct-ivy flyspell-correct flycheck-rust flycheck-rtags flycheck-pos-tip pos-tip flycheck-haskell flycheck-elm flycheck-bashate flx-ido flx fish-mode fill-column-indicator fancy-battery eyebrowse expand-region exec-path-from-shell evil-visualstar evil-visual-mark-mode evil-unimpaired evil-tutor evil-surround evil-snipe evil-search-highlight-persist evil-org evil-numbers evil-nerd-commenter evil-mc evil-matchit evil-magit magit git-commit ghub with-editor evil-lisp-state evil-lion evil-indent-plus evil-iedit-state iedit evil-exchange evil-escape evil-ediff evil-cleverparens smartparens evil-args evil-anzu anzu evil goto-chg undo-tree eshell-z eshell-prompt-extras esh-help erlang erc-yt erc-view-log erc-social-graph erc-image erc-hl-nicks emojify ht emoji-cheat-sheet-plus emmet-mode elm-mode elisp-slime-nav editorconfig ebuild-mode dumb-jump dockerfile-mode docker json-mode tablist magit-popup docker-tramp json-snatcher json-reformat disaster diminish diff-hl define-word dante flycheck dactyl-mode cython-mode csv-mode counsel-projectile projectile counsel-gtags counsel-dash helm-dash counsel swiper ivy company-web web-completion-data company-tern dash-functional tern company-statistics company-shell company-rtags rtags company-restclient restclient know-your-http-well company-nixos-options nixos-options company-ghci company-ghc ghc haskell-mode company-emoji company-coq company-math math-symbol-lists company-cabal company-c-headers company-auctex company-anaconda company common-lisp-snippets column-enforce-mode coffee-mode cmm-mode cmake-mode cmake-ide levenshtein clojure-snippets clojure-cheatsheet helm helm-core clojars request-deferred request deferred clj-refactor hydra inflections edn multiple-cursors paredit peg clean-aindent-mode clang-format cider-eval-sexp-fu eval-sexp-fu highlight cider spinner queue pkg-info clojure-mode epl cargo rust-mode browse-at-remote bind-map bind-key auto-yasnippet yasnippet auto-highlight-symbol auto-dictionary auto-compile packed auctex async arduino-mode anaconda-mode pythonic f dash s alert log4e gntp aggressive-indent adaptive-wrap ace-window ace-link avy ac-ispell auto-complete popup))))
