...
(define ghc-boot-th
  (package
   ...
   (source
    (origin
     (method url-fetch)
     (uri (string-append "https://hackage.haskell.org/package/ghc-boot-th/ghc-boot-th-" version ".tar.gz"))
     (sha256 (base32 "1w7qkgwpbp5h0hm8p2b5bbysyvnjrqbkqkfzd4ngz0yxy9qy402x"))))
...
(define ghc-boot
  (package
   ...
   (source
    (origin
     (method url-fetch)
     (uri (string-append "https://hackage.haskell.org/package/ghc-boot/ghc-boot-" version ".tar.gz"))
     (sha256 (base32 "0q446bcz38rql96k42yvfyhdg98lycijva1smw2izwv04hx200zp"))))
   (build-system haskell-build-system)
   (inputs `(("ghc-boot-th" ,ghc-boot-th)))
   (home-page "http://hackage.haskell.org/package/ghc-boot")
  ...
  (package
   ...
   (source
    (origin
     (method url-fetch)
     (uri (string-append
           "https://hackage.haskell.org/package/ghc-exactprint/ghc-exactprint-" version ".tar.gz"))
     (sha256 (base32 "141k6qiys0m0r4br7ikp4i546vs3xcil9cwglzcdfcbnb5nj1z87"))))
   (build-system haskell-build-system)
   (inputs
    `(("ghc-paths" ,ghc-paths)
      ("ghc-mtl" ,ghc-mtl)
  ...
  (package
   ...
   (source
    (origin
     (method url-fetch)
     (uri (string-append
           "https://hackage.haskell.org/package/apply-refact/apply-refact-" version ".tar.gz"))
     (sha256 (base32 "0578ql80fzkbjiw589v4498qd9jd7l2sz626imkdybxr1lqbsm0p"))))
   (build-system haskell-build-system)
   (inputs
    `(("ghc-refact" ,ghc-refact)
      ...
      ("ghc-silently" ,ghc-silently)))
   (home-page "http://hackage.haskell.org/package/apply-refact")
...
(define ghc-process-extras
  (package
   ...
   (source
    (origin
     (method url-fetch)
     (uri (string-append "https://hackage.haskell.org/package/process-extras/process-extras-" version ".tar.gz"))
...
(define ghc-process
  (package
   ...
   (source
    (origin
     (method url-fetch)
     (uri (string-append "https://hackage.haskell.org/package/process/process-" version ".tar.gz"))
     (sha256 (base32 "1w12ssmwpz5glmm964rxdc3fgi2w5sq9lac17rxs8p626r5p6rkn"))))
   (build-system haskell-build-system)
  ...
  (package
   ...
   (source
    (origin
     (method url-fetch)
     (uri (string-append
           "https://hackage.haskell.org/package/concurrent-output/concurrent-output-" version ".tar.gz"))
     (sha256 (base32 "0w5x81n9ljs8l2b8ypy2naazvrv16qqlm1lfzvsksnii2nm1al30"))))
   (build-system haskell-build-system)
   (inputs
    `(("ghc-async" ,ghc-async)
      ("ghc-stm" ,ghc-stm)
  ...
  (package
   ...
   (source
    (origin
     (method url-fetch)
     (uri (string-append
           "https://hackage.haskell.org/package/wl-pprint-annotated/wl-pprint-annotated-" version ".tar.gz"))
     (sha256 (base32 "1br7qyf27iza213inwhf9bm2k6in0zbmfw6w4clqlc9f9cj2nrkb"))))
   (build-system haskell-build-system)
   (native-inputs
    `(("ghc-tasty" ,ghc-tasty)
  ...
  (package
   ...
   (source
    (origin
     (method url-fetch)
     (uri (string-append
           "https://hackage.haskell.org/package/hedgehog/hedgehog-" version ".tar.gz"))
     (sha256 (base32 "1vv8vnkv6d0fvm0vwfm11ajyd9da3hfy2wdkd4p7dhfyscq9cwx4"))))
   (build-system haskell-build-system)
   (inputs
    `(("ghc-ansi-terminal" ,ghc-ansi-terminal)
      ("ghc-async" ,ghc-async)
  ...
  (package
   ...
   (source
    (origin
     (method url-fetch)
     (uri (string-append
           "https://hackage.haskell.org/package/pretty-show/pretty-show-" version ".tar.gz"))
     (sha256 (base32 "0l03mhbdnf0sj6kw2s3cf2xhfbl0809jr9fhj7cmpkhjpxv89vnv"))))
   (build-system haskell-build-system)
   (native-inputs
    `(("ghc-happy" ,ghc-happy)))
   (inputs
   ...
   (synopsis "Tools for working with derived `Show` instances and generic inspection of values.")
   (description
  ...
  (package
   ...
   (source
    (origin
     (method url-fetch)
     (uri (string-append
           "https://hackage.haskell.org/package/bsb-http-chunked/bsb-http-chunked-" version ".tar.gz"))
     (sha256 (base32 "0z0f18yc6zlwh29c6175ivfcin325lvi4irpvv0n3cmq7vi0k0ql"))))
   (build-system haskell-build-system)
   (arguments `(#:tests? #f))
  ...
  (package
   ...
   (source
    (origin
     (method url-fetch)
     (uri (string-append
           "https://hackage.haskell.org/package/streaming-commons/streaming-commons-" version ".tar.gz"))
     (sha256 (base32 "19qp8bnnfs31jk08991lmj3dywbjxh9iydriifbdjj2mvy8axz23"))))
   (build-system haskell-build-system)
   (inputs
    `(("ghc-async" ,ghc-async)
  ...
  (package
   ...
   (source
    (origin
     (method url-fetch)
     (uri (string-append
           "https://hackage.haskell.org/package/" "warp-" version "/" "warp-" version ".tar.gz"))
     (sha256 (base32 "0rl59bs99c3wwwyc1ibq0v11mkc7pxpy28r9hdlmjsqmdwn8y2vy"))))
   (build-system haskell-build-system)
   (arguments
  ...
  (package
   ...
   (source
    (origin
     (method url-fetch)
     (uri (string-append
           "https://hackage.haskell.org/package/" "warp-tls-" version "/" "warp-tls-" version ".tar.gz"))
     (sha256 (base32 "14m2bzk5ivz9gdpxlcj6qnh46f2lycm1ybdjnfkj2876zrqwii7m"))))
   (build-system haskell-build-system)
   (inputs
  ...
  (package
   ...
   (source
    (origin
     (method url-fetch)
     (uri (string-append
           "https://hackage.haskell.org/package/" "http-conduit-" version "/" "http-conduit-" version ".tar.gz"))
     (sha256 (base32 "1iay4hr0mj8brkxvgkv1liqa8irl9axfc3qhn8qsvcyq4n1l95km"))))
   (build-system haskell-build-system)
  ...
  (package
   ...
   (source
    (origin
     (method url-fetch)
     (uri (string-append
           "https://hackage.haskell.org/package/hoogle/hoogle-" version ".tar.gz"))
     (sha256 (base32 "009brgwczkszmlk8rq6s5s73rnpi2gw94wr9wwp9rgf3r2cfs1br"))))
   (build-system haskell-build-system)
   (inputs
