...
(setq
 ...
 (append
  '((haskell-stylish-on-save . nil)
    ...
    (projectile-compilation-command . "env -u GHC_PACKAGE_PATH cabal new-build")
    (projectile-run-command . "cargo run")
    (projectile-run-command . "env -u GHC_PACKAGE_PATH PORT=4000 cabal new-run exe:refl-club -- .static")
